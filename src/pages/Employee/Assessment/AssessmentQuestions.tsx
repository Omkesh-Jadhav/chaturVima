  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      ...
      try {
        ...
        setCycleNames((prev) => ({
          ...prev,
          [selectedQuestionnaire]: cycle_name || getCycleId(assessment.submission_name) // fallback to extracted if missing
        }));
                              ...
                              return (
                                <div key={questionnaire} className="space-y-1">
                                  ...
                                  <div className="relative h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                    <motion.div
                                      className={`absolute inset-y-0 left-0 rounded-full ${answered === total ? "bg-green-500" : "bg-gray-400"
                                        }`}
                                      initial={{ width: 0 }}
                                      animate={{
